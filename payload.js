/*
This file is copied from https://github.com/AloneMonkey/frida-ios-dump
which created by AloneMonkey
Maybe modified by me (everettjf) in the future, maybe not.
*/
...
function dumpModule(name) {
    ...
    var newmodpath = getDocumentDir() + "/" + newmodname + ".woza";
